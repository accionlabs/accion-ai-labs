      ...
      <section className="px-6 py-16">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h1 className="text-2xl sm:text-4xl lg:text-6xl font-bold text-gray-900 mt-6 mb-6">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 px-4">
              <Link
                to="/technical-debt"
                className="inline-flex items-center justify-center px-6 py-3 text-base sm:text-lg font-semibold text-white bg-gradient-to-r from-orange-500 to-red-500 rounded-xl hover:from-orange-600 hover:to-red-600 transition-all transform hover:scale-105 shadow-lg"
              >
            ...
            <div className="relative bg-gray-900 rounded-2xl shadow-2xl overflow-hidden">
              ...
              <div className="relative aspect-video">
                ...
                <div className="absolute top-0 left-0 right-0 bg-gradient-to-b from-black/70 to-transparent p-4 sm:p-8">
                  <h2 className="text-lg sm:text-2xl lg:text-4xl font-bold text-white text-center">
